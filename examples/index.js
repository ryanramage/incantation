...
async function run () {
  const pm2 = await PM2()
  const rune1 = NodeProjectRune(path.join(__dirname, '/smolserver/1.0.1', './index.js'))
  NodeProjectRune(path.join(__dirname, '/smolserver/1.0.2', './index.js'))
  ...
  await incantationManager.start(rune1)
